...
import com.eclept.andjelazoric_eclept_be_labflow.notification.NotificationService;
...
public class TestProcessor {
    ...
    public TestProcessor(TechnicianService technicianService, TestRequestService testRequestService, NotificationService notificationService, TestRequestProducer producer) {
    ...
    private void processTestSimulation(TestRequest testRequest, Technician tech) throws InterruptedException {
        ...
        if (!testRequest.isWalkIn()) {
            notificationService.notifyHospitalTestCompleted(testRequest);
        }
